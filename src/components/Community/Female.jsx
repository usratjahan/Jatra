...
import { getEventsByCommunity } from "../../services/eventsService";
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        const raw = await getEventsByCommunity("Female");
        const mapped = raw
          .filter((e) => e.community === "Female")
          .map((e) => ({
            id: e.id,
            title: e.title,
            location: e.location,
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {derivedDivisions.map((division) => (
                      ...
                      >
                        <div
                          className={`w-5 h-5 rounded-md flex items-center justify-center border-2 flex-shrink-0 transition-all ${selectedDivisions.includes(division) ? "bg-teal-600 border-teal-600" : "border-gray-300 group-hover:border-teal-400"}`}
                        >
