...
const EventCard = ({ event }) => {
  ...
  const imageSrc = event.image || travelHeader;
  return (
  <div
  ...
  useEffect(() => {
    (async () => {
      try {
        setLoading(true);
        setError("");
        const raw = await getEventsByCommunity("Family");
        setEvents(raw);
        setFiltered(raw);
      } catch (err) {
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          ...
          <div className="flex-1 min-w-0">
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-32 text-center bg-white/70 backdrop-blur-sm rounded-3xl border border-red-100">
